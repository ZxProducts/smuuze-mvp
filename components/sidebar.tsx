...
import { Clock, Calendar, FileText, LayoutDashboard, BarChart2, FolderGit2, Users2 } from "lucide-react"
  ...
  return (
    <div className="w-64 border-r bg-gray-50">
      <nav className="flex flex-col gap-1 p-2">
        <Button variant={activePage === "timesheet" ? "secondary" : "ghost"} className="justify-start gap-2" asChild>
          <Link href="/timesheet">
